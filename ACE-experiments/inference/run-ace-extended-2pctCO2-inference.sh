...
for ensemble_member in 0 1; do
    for model in "${!MODELS[@]}"; do
        for job_name in ${DATE}-$model-extended-2pctCO2-inference ${DATE}-$model-extended-2pctCO2-inference-second-ensemble-member; do
            ...
            spin_up_overrides="\
                ...
                initial_condition.start_indices.times=[2030-01-01T06:00:00] \
