...
CONFIG_FILENAME="ace-abrupt-4xCO2-data-only-evaluator-config.yaml"
...
job_name="abrupt-4xCO2-data-only-evaluator"
gantry run \
    --remote https://github.com/ai2cm/ace \
    --ref 4ca6589b5189e82b89ea3c500862871a703d0ded \
    --name $job_name \
    --description 'Run ACE abrupt 4xCO2 data-only evaluator' \
